                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
								<h4 class="m-t-0 header-title" align=Center><b>KEGIATAN</b></h4>
                                    <table id="datatable" class="table table-striped table-bordered">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Kegiatan</h2></th>
                                                </tr>
                                            </thead>
                                            <tbody >
												<?php foreach($ListKegiatan as $row) { ?>
                                                <tr>
												<?php if($row->notifikasi == 'dibaca') { ?>
                                                    <td>
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;">Tanggal/Bulan/Tahun: <?php echo $row->tanggal_kegiatan ?></h5>
									
									</div>
									<div class="panel-body">
										<p>Nama : <?php echo $row->nama ?> </p><br>
										<p  class="page-header">nis : <?php echo $row->nis ?> </p><br>
										<p align=right>
											<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Orang_Tua/viewKegiatan/<?php echo $row->nis ?>/<?php echo $row->tanggal_kegiatan ?>">Lihat</a></button>
