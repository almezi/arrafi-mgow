                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-heading">
										<h3 class="panel-title" align=center style="color:white;">Tanggal-Bulan-Tahun : <?php echo $row->tanggal_kegiatan; ?></h3>
									</div>
									
									<div class="panel-body">
									<p  class="page-header">Kelas : <?php echo $row->nama; ?></p><br>
										<h3 class="panel-title" align=right>
										<form action="<?php echo base_url(); ?>index.php/Wali_Kelas/viewKegiatan2" method="get">
										<input type="hidden" class="form-control" name="tgl" value="<?php echo $row->tanggal_kegiatan; ?>">
										<input type="hidden" class="form-control" name="kls" value="<?php echo $row->nama; ?>">
