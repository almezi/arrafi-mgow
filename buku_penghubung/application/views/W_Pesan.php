                        		...
                        		<div class="card-box" align=center>
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
											...
											height:80px;">
												<h4 class="m-t-0 header-title"><b><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/addPesan" style="color:white">Buat Pesan</a></b></h4>
											</button>
										...
										<button class="btn btn-primary waves-effect waves-light" type="submit" style="margin: 20px; width:350px; 
											height:80px;">
												<h4 class="m-t-0 header-title"><b><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/viewPesanMasuk" style="color:white">Pesan Masuk</a></b></h4>
											</button>
										</div>
										<div class="form-group text-center m-b-0">
										<button class="btn btn-primary waves-effect waves-light" type="submit" style="margin: 20px; width:350px; 
											height:80px;">
												<h4 class="m-t-0 header-title"><b><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/viewPesanTerkirim" style="color:white">Pesan Terkirim</a></b></h4>
											</button>
										</div>
										</form>
                        				</div>
