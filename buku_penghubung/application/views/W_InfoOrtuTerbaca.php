                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
								<?php foreach($listInfoOrtuTerbaca as $row) { ?>
								<h4 class="m-t-0 header-title page-header">
								<b>Tanggal Pelaksanaan : <?php echo $row->tanggal_informasi ?></br>
									Informasi : <?php echo $row->subject_informasi ?> </b>
									<?php echo $info['id_informasi']; ?>
								</h4>
								<?php } ?>
                                    <table id="datatable" class="table table-striped table-bordered">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Nama</h2></th>
                                            ...
                                            <tbody>
											<?php 
											$id=$info['id_informasi'];
											foreach($Ortu as $row) {
												$id_ortu=$row->idortu;
												$c= $this->db->query("SELECT DISTINCT (d.id_informasi) id,d.notifikasi_O status
												FROM ortu o
												JOIN detail_informasi d ON ( o.idortu = d.idortu ) 
												JOIN informasi i ON (i.id_informasi=d.id_informasi) 
												WHERE d.id_informasi =$id and d.idortu=$id_ortu limit 1")->row_array();
												$status = $c['status'];
											?>
                                                <tr>
                                                    <td>
