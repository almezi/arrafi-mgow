...
<html>
    <head>
		...
		<script language="JavaScript">
			setInterval("SANAjaxLitSar();", 1000 );  // set berapa detik melakukan refresh div

			$(function() {
				SANAjaxLitSar = function(){
				$('#LihatSaran').load("<?php echo base_url(); ?>index.php/Orang_Tua/LihatSaran").fadeIn("slow");  // load berarti melakukan load file
			}
			});
		</script>
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                                    <table  class="table table-striped table-bordered">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Respon Wali Kelas</h2></th>
                                                </tr>
                                            </thead>
                                            <tbody id="LihatSaran">
