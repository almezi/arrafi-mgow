...
<html>
    <head>
		...
		<script type='text/javascript' src='<?php echo base_url();?>arrafi/ubold/assets/js/jquery-1.8.2.min.js'></script>
		<script type='text/javascript' src='<?php echo base_url();?>arrafi/ubold/assets/js/jquery.autocomplete.js'></script>

		<!-- Memanggil file .css untuk style saat data dicari dalam filed -->
		<link href='<?php echo base_url();?>arrafi/ubold/assets/js/jquery.autocomplete.css' rel='stylesheet' />
		
		<script type='text/javascript'>
        $(document).ready(function(){
			$('#nama').autocomplete({
				source:"<?php echo site_url('Wali_Kelas/searchNama/?'); ?>"
			})
		})
    </script>
    ...
    <body class="fixed-left">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box" align=center>
                        			<h4 class="m-t-0 header-title"><b>Kegiatan</b></h4>
												...
												<form  class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/addKegiatanPersonal" method="post">
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">NISN</label>
	                                                <input type="hidden" class="form-control" name="kelas" value="<?php echo $kls['Kelas'];?>">
													<div class="col-md-8" align=left>
	                                                    <select class="selectpicker show-tick" data-style="btn-white" name="NISN">
														<?php foreach($listMahasiswa as $row) { ?>
													<option value="<?php echo $row->NISN ?>"> <?php echo $row->NISN ?> => (Nama : <?php echo $row->nama ?> || Kelas : <?php echo $row->Kelas ?>)</option>
														<?php } ?>
												</select>
													</div>
												...
												<div class="form-group">
													...
													<span class="input-group-addon btn btn-primary b-0 text-white"><a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/tambahMataPelajaranPersonal">+</a></span>
												</div>
												</div>
												</div>
                                                ...
                                                <tr>
													...
													<div class="col-sm-12">
														<div class="radio radio-purple">
															...
															<input id="" type="radio" name="status" value="TUNTAS" data-parsley-multiple="group1" required>
													...
													<div class="col-sm-14">
														<div class="radio radio-purple">
															...
															<input id="" type="radio" name="status" value="TIDAK TUNTAS" data-parsley-multiple="group1" required>
															<label for="radio"></label>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>arrafi/ubold/assets/plugins/multiselect/js/jquery.multi-select.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>arrafi/ubold/assets/plugins/jquery-quicksearch/jquery.quicksearch.js"></script>
