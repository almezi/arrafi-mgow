...
<html>
    <head>
		...
		function myFunction() {
			...
			document.getElementById("Catatan").innerHTML = x;
		}
		</script>
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
	                                            ...
	                                            <div class="form-group">
													...
													<?php foreach($listKegiatan3 as $row) { ?>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <input type="hidden" class="form-control" name="KLS" value="<?php echo $row->kelas ?>">
													<div class="col-md-8">
	                                                    <select class="selectpicker show-tick" data-style="btn-white" name="nis">
													<option value="<?php echo $row->nis ?>"> <?php echo $row->nis ?> => (Nama : <?php echo $row->nama ?> || Kelas : <?php echo $row->kelas ?>)</option>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
	                                                   <input type="text" class="form-control"  readonly="<?php echo $row->nama_kegiatan ?>" name="kegiatan" value="<?php echo $row->nama_kegiatan ?>" required>
													</div>
												</div>
