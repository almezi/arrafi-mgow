                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;">Laporan Tanggal <?php echo $row->tanggal_laporan?><br><br>
									...
									<div class="panel-body">
										...
										<p align=right>
                                                   ...
                                                   <a style="color:white;" href="<?php echo base_url()?>index.php/Wali_Kelas/viewDetailLaporan/<?php echo $row->id_laporan?>/<?php echo $row->nip?>/<?php echo $row->id_pembahasan?>">Lihat </a></button>
										</p>
										<p align=right>
										<button type="button" class="btn btn-success waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-check"></i>
                                                   </span>
												   <a style="color:white;" href="<?php echo base_url()?>index.php/Wali_Kelas/edit_Laporan/<?php echo $row->id_laporan?>/<?php echo $row->id_pembahasan?>">Edit</a>
												   </button>

                                                <button type="button" class="btn btn-danger waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-times"></i></span>
												   <a style="color:white;" href="<?php echo base_url()?>index.php/Wali_Kelas/deleteLaporan/<?php echo $row->id_laporan?>">Hapus</a>
												   </button>
										</p>
									</div>
									</div>
