                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
								<h4 class="m-t-0 header-title page-header" align=center><b>Buat Pembahasan Wali Kelas <?php echo $nip["nama"];?> || Kelas <?php echo $nip["kelas"];?></b></h4>
								<div class="row">
									<div class="col-md-15">
									<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Orang_Tua/addPembahasan/<?php echo $nip['nip'];?>" method="post">
												
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Pembahasan</label>
	                                                <div class="col-sm-8">
																<input type="text" class="form-control" placeholder="Pembahasan" name="pembahasan"  required>
			                                			</div>
                                            </div>
											<div class="form-group">
												<input type="hidden" class="form-control" placeholder="Enter your text" name="dari" value="<?php echo $user1['nama'];?>">
												<input type="hidden" class="form-control" placeholder="Enter your text" name="nip" value="<?php echo $nip['nip'];?>">
												<?php 
												$i = 0;
												foreach($listOrangtua2 as $row) { ?>
												<input type="hidden" class="form-control" placeholder="Enter your text" name="idortu[<?php echo $i?>]" value="<?php echo $row->idortu?>">
												<?php  
												$i++; } 	
												?> 
											</div>
                                            ...
                                            <tbody>
											   <tr>
                                                    <td >
													<div class="col-md-12">
	                                                    <textarea class="form-control" COLS=13 ROWS=12 name="isi_res" required></textarea>
	                                                </div>
												</td>
												</tr> 
												<tr>
