                    ...
                    <div class="container">
                        ...
                        <div class="row">
                           <div class="card-box">
							...
							<h2 class="panel-title page-header" align=center><p>Saran Orang Tua Tanggal <?php echo $_GET['awal'];?> <br>
												   Dari : <?php echo $row->nama?> || <?php echo $row->kelas?> <?php $nip=$row->nip?> <br>
												   (<?php echo $row->nama_pembahasan?>)
												   </p></h2>
							<?php } ?>
							<?php } else { ?>
							<?php foreach($listSaranWali as $row) { ?>
                                                   <h2 class="panel-title page-header" align=center><p>Saran Orang Tua Tanggal <?php echo $_GET['awal'];?> - <?php echo $_GET['akhir'];?> <br>
												   Dari : <?php echo $row->nama?> || <?php echo $row->kelas?> <?php $nip=$row->nip?> <br>
												   (<?php echo $row->nama_pembahasan?>)
												   </p></h2>
							<?php } ?>
							...
							<form action="<?php echo base_url(); ?>index.php/Wali_Kelas/LihatDetailSaranOrtu" method="get" class="form-horizontal" role="form" style="margin-top:20px;">
							 <?php foreach($listSaranWali as $row) { ?>
												   ...
												   <input type="hidden" name="pembahasan" value="<?php echo $row->id_pembahasan?>">
							<?php } ?>
							<div class="form-group">
			                   <label class="control-label col-sm-3">Tanggal : </label>
								 ...
								 <table id="datatable" class="table table-striped table-bordered dataTable no-footer">
											...
											<tr>
											<td colspan=4>
											<?php if($jumlahListSaran == 0 ) { ?>
											
											<?php } else { ?>
											<button type="button" class="btn btn-primary waves-effect waves-light" style="width:300px; height:50px; ">
											<?php foreach($listSaranWali as $row) { ?>
                                                   <a href="<?php echo base_url(); ?>index.php/Wali_Kelas/CetakSaran/<?php echo $_GET['awal'];?>/<?php echo $_GET['akhir'];?>/<?php echo $row->nip?>/<?php echo $_GET['pembahasan'];?>" style="color:white;">Cetak</a>
											<?php } ?>
											</button>
											<?php } ?>
											</td>
