                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li class="has_sub">
                                <a href="<?php echo base_url(); ?>index.php/Orang_Tua/homePesan" class="waves-effect active"><i class=" md-email"></i> <span>Pesan</span> </a>
                                <ul class="list-unstyled">
									<li><a href="<?php echo base_url(); ?>index.php/Orang_Tua/viewPesanMasuk">Lihat Pesan Masuk</a></li>
                                    <li class="active"><a href="<?php echo base_url(); ?>index.php/Orang_Tua/viewPesanTerkirim">Lihat Pesan Terkirim</a></li>
                                </ul>
                            </li>
							<li>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                                    <h4 class="m-t-0 header-title" align=center><b>Pesan</b></h4>
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
                                            ...
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Pesan Terkirim</h2></th>
                                                </tr>
                                            </thead>


                                            <tbody>
											<?php foreach($ListPesanTerkirim as $row) { ?>
                                                <tr>
                                                    <td>
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;"><?php echo $row->tanggal_pesan?> Dari <?php echo $row->dari?> </h5>
									
									</div>
									<div class="panel-body">
										<z ><center class="page-header"><?php echo $row->isi_pesan ?></center></z>
										
										<p align=right>
											<button type="submit" class="btn btn-primary waves-effect waves-light">
											<a style="color:white;" href="<?php echo base_url()?>index.php/Orang_Tua/viewPesanHistory/<?php echo $row->nomor ?>">History</a></button>
											...
											<p align=right>
												<button type="button" class="btn btn-success waves-effect waves-light">
												   ...
												   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Orang_Tua/editPesan/<?php echo $row->id_pesan ?>">Edit</a>
												</button>

                                                <button type="button" class="btn btn-danger waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-times"></i>
                                                   </span>
												   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Orang_Tua/hapusPesan/<?php echo $row->id_pesan ?>">Hapus</a>
												</button>
										</p>
									</div>
									</div>
