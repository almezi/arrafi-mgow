                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-body">
										...
										<p  class="page-header">Tanggal Pelaksanaan : <?php echo $row->tanggal_informasi ?></p>
										<p align=right>
													<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                   <a style="color:white" href="<?php echo base_url(); ?>index.php/Wali_Kelas/viewInformasiTerbaca2/<?php echo $row->id_informasi ?>">Lihat Informasi Terbaca</a></button>
