                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                                    <table id="datatable" class="table table-striped table-bordered">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Informasi Terkirim</h2></th>
                                                </tr>
                                            </thead>


                                            <tbody>
											<?php foreach($listInformasi as $row) { ?>
                                                <tr>
                                                    <td>
									...
									<div class="panel-body">
										<p  >Informasi : <?php echo $row->subject_informasi ?></p><br>
										<p  class="page-header">Tanggal Pelaksanaan : <?php echo $row->tanggal_informasi ?></p><br>
										<p align=right>
												<button type="button" class="btn btn-success waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-check"></i>
                                                   </span> <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/editInformasi/<?php echo $row->id_informasi ?>">Edit</a></button>

                                                <button type="button" class="btn btn-danger waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-times"></i>
                                                   </span> <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/hapusInformasi/<?php echo $row->id_informasi ?>">Hapus</a></button>
										</p>
									</div>
									</div>
