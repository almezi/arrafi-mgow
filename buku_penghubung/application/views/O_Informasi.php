                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li>
                                <a href="<?php echo base_url(); ?>index.php/Orang_Tua/homeInformasi" class="waves-effect active" ><i class=" ti-info"></i> <span>Informasi</span> </a>
                            </li>
							<li class="has_sub">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                                    <table id="datatable" class="table table-striped table-bordered">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Informasi</h2></th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
												...
												<tr>
												<?php if($row->notifikasi_O == 'dibaca') { ?>
                                                    <td>
													<div class="panel panel-primary">
									<div class="panel-heading">
									
										<h5 class="panel-title" align=center style="color:white;">Tanggal-Bulan-Tahun : <?php echo $row->tanggal ?></h5>
									
									</div>
									<div class="panel-body">
										<p class="page-header">
										Tanggal Informasi : <?php echo $row->tanggal_informasi ?><br>
										Subject Informasi : <?php echo $row->subject_informasi ?><br>
										<p align=right>
															<div class="checkbox checkbox-purple" >
															<input align=right id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url(); ?>index.php/Orang_Tua/readInformasi2/<?php echo $row->id_informasi ?>/<?php echo $row->idortu ?>'">
															<label for="checkbox"> *Centang untuk Membaca Informasi </label>
														</div>
									...
									<div class="panel-body">
										...
										<p align=right>
														...
														<div class="checkbox checkbox-purple" align=right>
															<input align=right id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url(); ?>index.php/Orang_Tua/readInformasi2/<?php echo $row->id_informasi ?>/<?php echo $row->idortu ?>'">
															<label for="checkbox">*Centang untuk Membaca Informasi </label>
														</div>
