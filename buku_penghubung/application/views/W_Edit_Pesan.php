                        			...
                        			<div class="row">
                        				<div class="col-md-15">
											...
											<div class="form-group">
	                                                ...
	                                                <div class="col-md-8">
	                                                    <select class="selectpicker show-tick" data-style="btn-white" name="idortu">
													<?php foreach($listMahasiswa_W as $row) { ?>
													<option <?php if($row->nis == $pesan['nis']){ echo"Selected"; }?> value="<?php echo $row->nis ?>"> <?php echo $row->nis ?> => (Nama : <?php echo $row->nama ?> || Kelas : <?php echo $row->kelas ?>)</option>
													<?php } ?>
												</select>
											...
											<?php foreach($listDataPesan as $row) { ?>
                                            ...
                                            <tbody>
                                                <tr>
	                                                ...
	                                                <div class="col-md-12" >
	                                                    <textarea class="form-control summernote" COLS=13 ROWS=12 name="isi_p" >
														<?php 
