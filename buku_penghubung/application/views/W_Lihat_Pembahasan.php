                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title page-header" align=center><b>Saran</b></h4>
                                    <table id="datatable" class="table table-striped table-bordered dataTable no-footer">
                                            <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Pembahasan Orang Tua</h2></th>
                                                </tr>
                                            </thead>
                                            <tbody>
											<?php 
												foreach($ListPembahasan as $row) {
													...
													$d = $this->db->query("SELECT  respon.dari nama_ortu, respon.tanggal tgl,pembahasan.status_pembahasan status
													FROM detail_respon JOIN respon USING( id_respon ) JOIN pembahasan USING(id_pembahasan)
													JOIN guru USING (nip)				
										...
										<h5 class="panel-title" align=center style="color:white;">Pembahasan Tanggal : <?php echo $tgl ?></h5>
									
									</div>
									<div class="panel-body">
										<p>Pembahasan : <?php echo $row->nama_pembahasan ?> </p><br>
										<p  class="page-header">pembuat : <?php echo $nama_ortu ?> </p><br>
										...
										<p align=right>
											<button type="submit" class="btn btn-inverse waves-effect waves-light">
                                                   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/homeSaran/<?php echo $row->id_pembahasan?>">Lihat</a></button>
									...
									<div class="panel-body">
										<p>Pembahasan : <?php echo $row->nama_pembahasan ?></p><br>
										<p  class="page-header">pembuat : <?php echo $nama_ortu ?> </p><br>
										<p> Status Pembahasan :  <span class="btn-label"><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/UpdateStatusPembahasan/<?php echo $row->id_pembahasan?>"><span class="label label-danger pull-right"><?php echo $status_p ?> </span></a></span></p><br>
										<p align=right>
											<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/homeSaran/<?php echo $row->id_pembahasan?>">Terbaca</a></button>
