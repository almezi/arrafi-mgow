										<?php $user= $this->session->userdata('uname');
											...
											$data=array();
											  foreach($listTanggal as $row) {
												...
												WHERE respon.NIP=$nomor and respon.tanggal='$data[$i]'
											...
											<li class="clearfix">
                                                <div class="chat-avatar">
                                                    ...
                                                    <div class="ctext-wrap">
														...
														<a href="<?php echo base_url(); ?>index.php/Wali_Kelas/editSaran/<?php echo $row->id_respon ?>">Edit</a> <z style="color:#DBDDDE;">|</z>
														<a href="<?php echo base_url(); ?>index.php/Wali_Kelas/hapusSaran/<?php echo $row->id_respon ?>">Hapus</a>
