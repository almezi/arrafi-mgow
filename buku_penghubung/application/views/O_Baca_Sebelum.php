                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-body">
										<p  align=center class="page-header panel-title"><?php echo $row->subject_informasi ?> | Tanggal Pelaksanaan : <?php echo $row->tanggal_informasi ?></p><br>
										<p>
										<div class="form-group" align=right>
													<?php if($cekInformasi > 0) { ?>
													<div class="col-sm-14">
														<div class="checkbox checkbox-purple">
															<label for="checkbox" ></label>
															<input align=right id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url();?>index.php/Orang_Tua/readInformasi3/<?php echo $row->id_informasi ?>'">
														</div>
													...
													<div class="col-sm-14">
														<div class="checkbox checkbox-purple">
														<input id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url();?>index.php/Orang_Tua/readInformasi2/<?php echo $row->id_informasi ?>'">
														<label for="checkbox" ></label>
														</div>
													</div>
												<?php } ?>	
