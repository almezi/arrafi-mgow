                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                                            ...
                                            <tbody align=center>
											   ...
											   <tr>
												...
												<td>
													...
													<div class="col-sm-14">
														<div class="checkbox checkbox-purple">
															<input id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url(); ?>index.php/Orang_Tua/viewPesanHistory/<?php echo $row->nomor ?>'">
												...
												<td>
													...
													<div class="col-sm-14">
														<div class="checkbox checkbox-purple">
															<input id="checkbox" type="checkbox" onclick="location.href='<?php echo base_url();?>index.php/Orang_Tua/addPesan2/<?php echo $row->id_pesan ?>/<?php echo $row->tanggal_pesan ?>/<?php echo $row->nip?>'">
															<label for="checkbox"> </label>
														</div>
													</div>
												</div>
										...
										<label class="col-sm-3 control-label">* Centang Untuk Membalas Pesan</label>
                        				</div>
                        			</div>
