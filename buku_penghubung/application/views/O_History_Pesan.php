                           ...
                           <div class="col-sm-12">
								...
								<h4 class="m-t-0 header-title" align=center><b>Pesan</b></h4>
                                    <div class="panel panel-primary">
												...
												<?php foreach($ListPesanHistory_Ortu as $row){ ?>
												<?php if($row->dari != $user1['nama']) { ?>
													<center class="page-header panel-title">
													Dari : <?php echo $row->dari?> <br>
													Tanggal : <?php echo $row->tanggal_pesan?><br>
													Pesan<br>
													<?php echo $row->isi_pesan?></center>
												<?php } else {?>	
													<br>
