                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;">Saran Orang Tua  <?php echo $row->tanggal?></h5>
									
									</div>
									<div class="panel-body">
										<p  class="page-header">Dari : <?php echo $row->nama?><br> 
										Kelas : <?php echo $row->kelas?> </p><br>
										<p  align=right>
										<p align=right>
													<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                   <a href="<?php echo base_url(); ?>index.php/Tata_Usaha/viewSaran/<?php echo $row->nip ?>/<?php echo $row->tanggal ?>" style="color:white;">Lihat </a></button>
