                        		...
                        		<div class="card-box" align=center>
									...
									<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/tambahInformasi" method="post">
												<div class="form-group">
	                                                ...
	                                                <div class="col-md-8">
	                                                    <input type="text"  class="form-control" placeholder="Subject Informasi" name="subject_info" value="<?php echo $this->session->flashdata('subject'); ?>" required>
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-8">
			                                				<div class="input-group" onclick="document.getElementById('demo').innerHTML = ''">
																<input type="text" class="form-control" placeholder="Tahun-Bulan-Tanggal" id="datepicker-autoclose" name="tgl_info" value="<?php echo $this->session->flashdata('tanggal'); ?>" required>
                                            ...
                                            <tbody>
											   <tr>
													...
													<div class="col-md-12" onclick="document.getElementById('demo2').innerHTML = ''">
	                                                    <textarea class="form-control summernote" COLS=13 ROWS=12 name="isi_info"><?php echo $this->session->flashdata('isi'); ?></textarea>
