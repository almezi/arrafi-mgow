...
<html>
    <head>
		...
		<script language="JavaScript">
			...
			$(function() {
				SANAjax = function(){
				$('#NotifDisplay').load("<?php echo base_url(); ?>index.php/Wali_Kelas/NotifWaliKelas").fadeIn("slow");  // load berarti melakukan load file
			}
			});
		</script>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" ><i class=" ti-notepad"></i> <span>Kegiatan</span> </a>
							...
							<li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li ><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/homeSaran">Buat Saran</a></li>
									<li class="active"><a href="<?php echo base_url(); ?>index.php/Wali_Kelas/SaranOrtu">Lihat Saran Orang Tua</a></li>
                                </ul>
                            </li>
							<li class="has_sub">
                         ...
                         <div class="row">
                           <div class="col-sm-12">
                        		<div class="card-box" align=center>
                        			<h4 class="m-t-0 header-title"><b>Pesan</b></h4>
                        			
                        			<div class="row">
                        				<div class="col-md-15">
											<form  class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Wali_Kelas/searchPesan" method="get">
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label"></label>
	                                                <div class="col-md-8">
														<?php foreach($listDataPesan2 as $row) { ?>
                                                        <input type="hidden" class="form-control"  name="id_p2" value="<?php echo $row->id_pesan ?>">
														<?php } ?>
                        					...
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/ubahPesan" method="post">
											
												<div class="form-group">
	                                                <label class="col-md-2 control-label">NISN</label>
	                                                <div class="col-md-8">
	                                                    <select class="selectpicker show-tick" data-style="btn-white" name="id_ortu">
													<?php foreach($listMahasiswa_W as $row) { ?>
												...
												<?php foreach($listDataPesan2 as $row) { ?>
												<input type="hidden" class="form-control" name="id_p" value="<?php echo $row->id_pesan ?>">
                                            ...
                                            <tbody align=center>
                                                <tr>
	                                                ...
	                                                <div class="col-md-12">
	                                                    <textarea required class="form-control" COLS=13 ROWS=12 name="isi_p" required><?php echo $row->isi_pesan ?></textarea>
