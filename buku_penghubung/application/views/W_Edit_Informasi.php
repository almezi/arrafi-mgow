                    ...
                    <div class="container">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                           <div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title" align="center"><b>Informasi</b></h4>
                        			
                        			<div class="row">
                        				<div class="col-md-15">
											<?php foreach($listDataInformasi as $row) { ?>
												<?php $id=$row->id_informasi ?>
											<?php } ?>
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/ubahInformasi/<?php echo $id ?>" method="post">
												<div class="form-group">
												<?php foreach($listDataInformasi as $row) { ?>
	                                                <label class="col-md-2 control-label">Subject Pengumuman</label>
	                                                <div class="col-md-8">
														<input type="hidden" class="form-control"  name="id_i" value="<?php echo $row->id_informasi ?>">
	                                                    <input type="text" class="form-control" placeholder="Subject Informasi" name="subject_info" 
														value="<?php 
														if ($this->session->flashdata('message') == TRUE) {
															echo $this->session->flashdata('subject');
														} else{
														echo $row->subject_informasi;
														} ?>" required>
	                                                </div>
	                                            </div>
												
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Tanggal Pengumuman</label>
	                                                <div class="col-sm-8">
			                                				<div class="input-group" onclick="document.getElementById('demo').innerHTML = ''">
																<input type="text" class="form-control" placeholder="Tahun-Bulan-Tanggal" id="datepicker-autoclose" name="tgl_info" value="<?php 
														if ($this->session->flashdata('Kosong') == TRUE) {
															echo $this->session->flashdata('tanggal');
														} else{
														echo $row->tanggal_informasi;
														} ?>" required>
																<span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
															</div><!-- input-group -->
															<ul class="parsley-errors-list filled" id="demo" ><li class="parsley-required"><?php echo $this->session->flashdata('message'); ?></li></ul>
			                                			</div>
                                            ...
                                            <tbody >
                                                <tr>
                                                    <td>
													<div class="col-md-12" onclick="document.getElementById('demo2').innerHTML = ''">
	                                                    <textarea class="form-control summernote" COLS=13 ROWS=12 name="isi_info"><?php 
														if ($this->session->flashdata('Kosong') == TRUE) {
															echo $this->session->flashdata('isi');
														} else{
														echo $row->isi_informasi;
														} ?></textarea>
