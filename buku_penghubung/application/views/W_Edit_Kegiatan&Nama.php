                        ...
                        <div class="row">
                           <div class="col-sm-12">
                        		<div class="card-box" align=center>
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
												<form  class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Wali_Kelas/search2" method="get">
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Kelas</label>
													<div class="col-md-8">
													<div class="input-group m-b-15">
													<div class="bootstrap-timepicker">
													<?php foreach($listKegiatan4 as $row) { ?>
														<input type="hidden" class="form-control" placeholder="kelas" name="id" value="<?php echo $row->id_kegiatan ?>">
														<?php } ?>
												...
												<form  class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/editKegiatan" method="post">
												
												
												<?php foreach($listKegiatan4 as $row) { ?>
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">NIS</label>
													<input type="hidden" class="form-control" name="id" value="<?php echo $row->id_kegiatan ?>">
													<input type="hidden" class="form-control" name="nip" value="<?php echo $row->nip ?>">
													<?php } ?>
	                                                <input type="hidden" class="form-control" name="KLS" value="<?php echo $kls['nama'];?>">
													<div class="col-md-8">
	                                                    <select class="selectpicker show-tick" data-style="btn-white" name="nis">
														<?php foreach($listMahasiswa as $row) { ?>
													<option <?php if( $row->nis == $kegiatan['nis'] ) { echo "Selected"; } ?> value="<?php echo $row->nis ?>"> <?php echo $row->nis ?> => (Nama : <?php echo $row->nama_siswa ?> || Kelas : <?php echo $row->nama ?>)</option>
														<?php } ?>
												</select>
													</div>
												...
												<div class="form-group">
													...
													<option <?php if( $row->nama_bab == $kegiatan['nama_kegiatan'] ) { echo "Selected"; } ?> value="<?php echo $row->nama_bab?>"> <?php echo $row->kelas ?> | <?php echo $row->nama_mapel ?> = <?php echo $row->nama_bab ?>  </option>
													<?php  } ?>
												</select>
													</div>
	                                            </div>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
	                                                   ...
	                                                   <input type="text" class="form-control" data-mask="9999/9999" placeholder="yyyy/yyyy" name="Tahun" value=<?php echo $row->tahun_ajaran ?> required>
													</div>
                                            ...
                                            <tbody align=center>
                                                 ...
                                                 <tr>
                                                    <?php if( $row->status  == 'TUNTAS'){?>
                                                    <td>
													<div class="form-group">
													<div class="col-sm-14">
														<div class="radio radio-purple">
															
															<input id="" type="radio" name="status" value="TUNTAS" checked="checked" onclick="document.getElementById('Catatan').innerHTML = ''" data-parsley-multiple="group1">
													...
													<div class="col-sm-14">
														<div class="radio radio-purple">
															...
															<input id="" type="radio" name="status" value="TIDAK TUNTAS" onclick="document.getElementById('Catatan').innerHTML = '<input  type=text class=form-control placeholder=Catatan name=catatan required  >'" data-parsley-multiple="group1">
															<label for="radio"></label>
												...
												<td>
													...
													<div class="col-sm-12">
														<div class="radio radio-purple">
															...
															<input id="" type="radio" name="status" value="TUNTAS" onclick="document.getElementById('Catatan').style.display='none'" data-parsley-multiple="group1">
															<label for="radio"></label>
													...
													<div class="col-sm-12">
														<div class="radio radio-purple">
															<input id="" type="radio" name="status" value="TIDAK TUNTAS"   onclick="document.getElementById('Catatan').style.display='block'" checked="checked" data-parsley-multiple="group1">
															<label for="radio"></label>
														</div>
													</div>
												</div>
												...
												<tr>
													...
													<div class="form-group" id="Catatan" >
														<?php if( $row->catatan  == NULL || $row->catatan == "(Tidak Ada Catatan)") {?>
	                                                    <input  type="hidden" class="form-control" placeholder="Catatan" name="catatan" value="<?php echo $row->catatan ?>" required  >
														<?php } else { ?>
														<input  type="text" class="form-control" placeholder="Catatan" name="catatan" value="<?php echo $row->catatan ?>" required  >
														<?php }  ?>
													</div>
													</td>
												</tr>
