                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;"><?php echo $row->tanggal_pesan ?> Dari Wali Kelas <?php echo $row->nama ?> <br>
										untuk <?php echo $row->siswa ?></h5>
									...
									<div class="panel-body">
										...
										<p align=right>
											...
											<a style="color:white;" href="<?php echo base_url()?>index.php/Orang_Tua/BalasPesan/<?php echo $row->id_pesan ?>/<?php echo $row->tanggal_pesan ?>/<?php echo $row->nomor ?>">Balas</a></button>
