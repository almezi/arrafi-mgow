            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"><?php echo $user1['nama'];?>
</h4>
                         ...
                         <div class="row">
                           <div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/tambahPesan" method="post">
                                            ...
                                            <tbody>
                                                <tr>
	                                               ...
	                                               <div class="col-md-12" onclick="document.getElementById('demo2').innerHTML = ''">
	                                                    <textarea  class="form-control summernote" COLS=13 ROWS=12 name="isi_p"></textarea>
