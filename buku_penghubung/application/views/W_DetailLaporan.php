                        ...
                        <div class="row">
						   ...
						   <form  class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Wali_Kelas/CariPembahasan" method="get">
	                                            <div class="form-group" >
													...
													<option  <?php if( $row->id_pembahasan == $bahas['id_pembahasan'] ) { echo "Selected"; } ?> value="<?php echo $row->id_pembahasan ?>"><?php echo $row->nama_pembahasan ?> </option>
													<?php } ?>
												</select>
													</div>
                        					...
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/addLaporan" method="post">
												<div class="form-group">
													...
													<div class="col-md-8">
	                                                   <input type="text" class="form-control"  readonly="Pembahasan" name="pembahasan" value="<?php echo $bahas['nama_pembahasan'];?>" required>
													   <input type="hidden" class="form-control"  readonly="Pembahasan" name="id_pembahasan" value="<?php echo $bahas['id_pembahasan'];?>" required>
													</div>
												</div>
												<div class="form-group">
