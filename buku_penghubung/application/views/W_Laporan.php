                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           <div class="card-box">
						   <div class="col-md-15">
						   <form  class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Wali_Kelas/CariPembahasan" method="get">
                        					...
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Wali_Kelas/addLaporan" method="post">
												<div class="form-group">
	                                                <label class="col-md-2 control-label">Judul Pembahasan</label>
													<div class="col-md-8">
	                                                   <input type="text" class="form-control"  readonly="Pembahasan" name="pembahasan" value="" required>
													   <input type="hidden" class="form-control"  readonly="Pembahasan" name="id_pembahasan" value="" required>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group m-b-4">
														<div class="col-sm-8">
															<div class="input-daterange input-group" >
																<input type="text" class="form-control" readonly="Jam Awal" name="awal" value="" required>
																<span class="input-group-addon btn-primary text-white">SD</span>
																<input type="text" class="form-control" readonly="Jam Akhir" name="akhir" value="" required>
															</div>
														</div>
													</div>
												</div> 
												...
												<div class="form-group">
													...
													<div class="col-md-2">
													<label class="col-md-1 control-label"><?php echo $jumlahOrtu;?></label> 
													</div>
												</div>
											   ...
											   <tr>
													...
													<div class="form-group">
														<div class="col-md-12" onclick="document.getElementById('demo2').innerHTML = ''">
															<textarea  class="form-control summernote" COLS=13 ROWS=12 name="isi"></textarea>
