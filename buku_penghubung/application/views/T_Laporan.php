                        ...
                        <ul>
							...
							<li class="has_sub">
								...
								<ul class="list-unstyled">
                                    <li class="active" ><a href="<?php echo base_url(); ?>index.php/Tata_Usaha/homeLaporan">Buat Laporan</a></li>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           ...
                           <div class="card-box">
						   <div class="col-md-15">
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Tata_Usaha/addLaporan" method="post">
