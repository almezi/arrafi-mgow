                        ...
                        <ul>
							...
							<li class="has_sub">
                                ...
                                <ul class="list-unstyled">
									<li class="active"><a href="<?php echo base_url(); ?>index.php/Orang_Tua/viewPesanMasuk">Lihat Pesan Masuk</a></li>
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-15">
                        					<form class="form-horizontal" role="form" action="<?php echo base_url()?>index.php/Orang_Tua/addPesan" method="post">
											<table id="datatable" class="table table-striped table-bordered" >
                                           <?php foreach($ListPesanWali as $row){ ?>
											   <tr>
                                                    <td align=center>
	                                                ...
	                                                <div class="col-md-12">
														...
														<input type="hidden" class="form-control" name="nomor" value="<?php echo $row->nomor ?>">
														<input type="hidden" class="form-control" name="nip" value="<?php echo $row->nip ?>">
														<input type="hidden" class="form-control" name="nis" value="<?php echo $row->nis ?>">
											...
											<?php } ?>
											   <tr>
													...
													<div class="form-group">
	                                                    ...
	                                                    <textarea class="form-control summernote" COLS=13 ROWS=12 name="isi_pesan"></textarea>
