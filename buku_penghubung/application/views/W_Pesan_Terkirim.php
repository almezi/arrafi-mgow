                        		...
                        		<div class="card-box">
                                    <table id="datatable" class="table table-striped table-bordered">
											...
											<?php foreach($listPesan as $row) { 
												$c = $this->db->query("SELECT nama nama FROM siswa where nis='$row->nis' limit 1")->row_array();
												$nama_siswa = $c['nama'];
											?>
											<?php if($row->status =='Belum Terbaca') { ?>
                                                <tr>
                                                    <td>
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;">Tanggal : <?php echo $row->tanggal_pesan ?></h5><br>
										<h5 class="panel-title" align=center style="color:white;"> Kepada <?php echo $nama_siswa ?> dengan NIS : <?php echo $row->nis ?>  | <?php echo $row->nama ?></h5><br>
										<h5 class="panel-title" align=center style="color:white;"> Status : Belum Dibaca </h5><br>
									</div>
									<div class="panel-body">
										<z ><center class="page-header"><?php echo $row->isi_pesan ?></center></z><br>
										<p align=right>
												<button type="button" class="btn btn-success waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-check"></i>
                                                   </span><a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/get_dataPesan/<?php echo $row->id_pesan ?>/<?php echo $row->idortu ?>">Edit</a>
												   </button>

                                                <button type="button" class="btn btn-danger waves-effect waves-light">
                                                   <span class="btn-label"><i class="fa fa-times"></i>
                                                   </span>
												   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/hapusPesan/<?php echo $row->id_pesan ?>">Hapus</a>
												   </button>
										</p><br>
									</div>
									</div>
									...
									<div class="panel-heading">
										...
										<h5 class="panel-title" align=center style="color:white;">Tanggal : <?php echo $row->tanggal_pesan ?></h5><br>
										<h5 class="panel-title" align=center style="color:white;"> Kepada <?php echo $nama_siswa ?> dengan NIS : <?php echo $row->nis ?> | <?php echo $row->nama ?></h5><br>
										<h5 class="panel-title" align=center style="color:white;"> Status : Terbaca </h5><br>
									</div>
									<div class="panel-body">
										<z ><center class="page-header"><?php echo $row->isi_pesan ?></center></z><br>
										<p align=right>
