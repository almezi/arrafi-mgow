...
<html>
    <head>
		...
		<script language="JavaScript">
			/*setInterval("SANAjaxMasuk();", 1000 );  // set berapa detik melakukan refresh div

			$(function() {
				SANAjaxMasuk = function(){
				$('#PesanMasuk').load("<?php echo base_url(); ?>index.php/Wali_Kelas/Refresh_viewPesanMasuk").fadeIn("slow");  // load berarti melakukan load file
			}
			});*/
		</script>
                           ...
                           <div class="col-sm-12">
								...
								<h4 class="m-t-0 header-title" align=Center><b>Pesan</b> </h4>
                                    ...
                                    <table id="datatable"  class="table table-striped table-bordered">
                                        <thead align=center>
                                                <tr>
                                                    <th><h2 class="panel-title" align=center>Data Pesan Masuk </h2></th>
                                                </tr>
                                            </thead>

											<tbody>
											<?php foreach($ListPesanMasuk as $row){ ?>
                                                <tr>
																				<?php if($row ->status == 'Terbaca'){ ?>
                                                    <td>
													<div class="panel panel-primary">
													<div class="panel-heading">
														<h5 class="panel-title" align=center style="color:white;">
														<?php echo $row->tanggal_pesan?> Dari  <?php echo $row->dari?></h5>
														
													</div>
												<div class="panel-body">
													<center class="page-header"><?php echo $row->isi_pesan?></center>
													<p align=right>
													<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                   <a style="color:white;" href="<?php echo base_url(); ?>index.php/Wali_Kelas/viewPesanHistory/<?php echo $row->nomor ?>/<?php echo $row->id_pesan ?>">History</a></button>
