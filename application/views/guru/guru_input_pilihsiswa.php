                        ...
                        <div class="panel-body">
							...
							<form role="form" action='<?php echo base_url()?>index.php/guru/guru_input_pilihsiswa?idmapel=<?php echo $_GET['idmapel']; ?>&namamapel=<?php echo $_GET['namamapel']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>&kelas=<?php echo $_GET['kelas']; ?>&idbab=""&tingkat=<?php echo $_GET['tingkat']; ?>&semester=<?php echo $_GET['semester']; ?>&tipe=<?php echo $_GET['tipe']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>' method='post' enctype='multipart/form-data'>
										<div class="form-group has-success" >
											...
											<?php } else if(isset( $_GET['idbab']))
											{?>
											<option value=""><?php echo $_GET['nama']; ?></option>
											<?php } else { ?>
							...
							?>
									...
									<form role="form" action='<?php echo base_url() ?>index.php/guru/jadremedeval?idmapel=<?php echo $_GET['idmapel']; ?>&namamapel=<?php echo $_GET['namamapel']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>&kelas=<?php echo $_GET['kelas']; ?>&idbab=<?php echo $_GET['idbab']; ?>&bab=<?php echo $namabab; ?>&tingkat=<?php echo $_GET['tingkat']; ?>&semester=<?php echo $_GET['semester']; ?>&tipe=<?php echo $_GET['tipe']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>' method='post' enctype='multipart/form-data'>
                                        <div class="form-group has-success" >
                                            ...
                                            <input type="date" name="jad" class="form-control" id="inputSuccess" value="<?php echo $jadwal; ?>" required>
									...
									<div class="col-xs-6 col-md-4">
										...
										<div class="form-group has-success">
										<label class="control-label" for="inputSuccess">Input Nilai Siswa</label>
										<a href="<?php echo base_url() ?>index.php/guru/tambah_nilai_siswa?idmapel=<?php echo $_GET['idmapel']; ?>&namamapel=<?php echo $_GET['namamapel']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>&kelas=<?php echo $_GET['kelas']; ?>&idbab=<?php echo $idbab; ?>&bab=<?php echo $namabab; ?>&tingkat=<?php echo $_GET['tingkat']; ?>&semester=<?php echo $_GET['semester']; ?>&tipe=<?php echo $_GET['tipe']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>"><button class="btn btn-info btn-sm" >
                                Input Nilai
                            </button></a>	
										</div>
							...
							<div style="margin:auto; border-radius:50px; height:50px; display:block;">
                                	<a href="<?php echo base_url()?>index.php/wali_kelas/wali_laporandkn?idmapel=<?php echo $_GET['idmapel']; ?>&namamapel=<?php echo $_GET['namamapel']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>&kelas=<?php echo $_GET['kelas']; ?>&semester=<?php echo $_GET['semester']; ?>&thnajar=<?php echo $_GET['thnajar']; ?>&tingkat=<?php echo $_GET['tingkat']; ?>"> <button type="button" class="btn btn-warning" target="_blank"><img src="<?php echo base_url(); ?>logo/icon_180.png" style="height:30px; width:30px;"/> Laporan DKN</button></a>
							</div>
							</center>
                            </div>
                            <!-- /.table-responsive -->
