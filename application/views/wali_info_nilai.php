                ...
                <div >
                    <div class="panel panel-default">
                        <div class="panel-heading">
						    ...
						    <a style="float:right;" href="<?php echo base_url()?>index.php/guru/wali_info_pilihsiswa?idmapel=<?php echo $_GET['idmapel']; ?>&namamapel=<?php echo $_GET['namamapel']; ?>&idkelas=<?php echo $_GET['idkelas']; ?>&kelas=<?php echo $_GET['kelas']; ?>&semester=<?php echo $_GET['semester']; ?>&tingkat=<?php echo $_GET['tingkat']; ?>&tipe=<?php echo $_GET['tipe']; ?>"> <button type="button" class="btn btn-success">Menu Siswa</button></a>
                        </div>
                        <!-- /.panel-heading -->
