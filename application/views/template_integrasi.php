...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url()?>assets/js/plugins/forms/selects/bootstrap_select.min.js"></script>></script>
		...
		<style>
			fieldset{
				position: absolute;margin-top: 0px;margin-left: -350px; margin-bottom: 0px;left: 50%;top: 0%; height: 50%; width: 50%;
			}
		</style>
					...
					<div id="sidebar-menu">
						<ul>
							...
							<li>
								...
								<span class="cap"> <?php echo $this->session->userdata('nama_group');?> </span>
								</a>
							</li>
							<li>
