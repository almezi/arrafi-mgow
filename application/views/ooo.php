...
<link href="<?php echo base_url()?>js1/css/bootstrap.min.css" rel="stylesheet">
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
<link href="<?php echo base_url()?>js1/css/font-awesome.css" rel="stylesheet">
<link href="<?php echo base_url()?>js1/css/style.css" rel="stylesheet">
<link href="<?php echo base_url()?>js1/css/pages/dashboard.css" rel="stylesheet">
...
<script src="<?php echo base_url()?>js1/js/jquery-1.7.2.min.js"></script> 
<script src="<?php echo base_url()?>js1/js/excanvas.min.js"></script> 
<script src="<?php echo base_url()?>js1/js/chart.min.js" type="text/javascript"></script> 
<script src="<?php echo base_url()?>js1/js/bootstrap.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo base_url()?>js1/js/full-calendar/fullcalendar.min.js"></script>
