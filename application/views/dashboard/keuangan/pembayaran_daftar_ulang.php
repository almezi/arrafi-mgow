                                                        ...
                                                        <center>
                                                            <?php
                                                                if ($status_konfirmasi=='Belum') {
                                                                    ...
                                                                    echo anchor('Daftar_Ulang_C/konfirmasi_pembayaran_daftar_ulang/'.$value->no_pendaftaran,'<i style="color:#34d3eb;" class="fa fa-check fa-2x fa-fw"></i><span></span>',$data);

                                                                    $data = array(
                                                                        'title' => 'Informasikan'
                                                                    );

                                                                    echo anchor('Daftar_Ulang_C/informasikan_pembayaran_daftar_ulang/'.$value->no_hp,'<i style="color:#ffbd4a;" class="fa fa-info fa-2x fa-fw"></i><span></span>',$data);
                                                                }
                                                            ?>
                                                        </center>
                                                    </td>
