                                                        ...
                                                        <center>
                                                            <?php
                                                                if ($status_konfirmasi=='Belum') {
                                                                    ...
                                                                    echo anchor('Her_Registrasi_C/konfirmasi_pembayaran_her_registrasi/'.$value->nis,'<i style="color:#34d3eb;" class="fa fa-check fa-2x fa-fw"></i><span></span>',$data);

                                                                    $data = array(
                                                                        'title' => 'Informasikan'
                                                                    );

                                                                    echo anchor('Her_Registrasi_C/informasikan_pembayaran_her_registrasi/'.$value->no_telp,'<i style="color:#ffbd4a;" class="fa fa-info fa-2x fa-fw"></i><span></span>',$data);
                                                                }
                                                            ?>
                                                        </center>
                                                    </td>
