...
<script>
    function search(){
        ...
        // var c  = $('#thn').val();
        $.ajax({
            url:"<?php echo base_url()?>index.php/c_arAdmin/filterKunjungan/"+a,
            success:function(data){
                // alert(data);
                $('#dataKunjungan').html(data);
                $('#cetak').attr("onClick","window.location = 'http://localhost/arrafi/index.php/c_arAdmin/pdf?<?php echo "nip=".$peg['id_pegawai']."&nama=".$peg['nama']."&" ?>bln="+a+"'")
            }
        });
    }
</script>
			...
			<div class="row">
				<div class="col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <button id="cetak" type="submit" class="btn btn-default" value="" onClick="window.location = 'http://localhost/arrafi/index.php/c_arAdmin/pdf?<?php echo "nip=".$peg['id_pegawai']."&nama=".$peg['nama']."&" ?>bln='">Cetak</button>
                        <?php $tahun=date('Y');?>
                        <a href="http://localhost/arrafi/index.php/c_arAdmin/grafik/<?php echo $tahun;?>"><button class="btn btn-default"> Grafik </button></a>
