		...
		<div class="container">
			<div class="row" >
                ...
                <div class="panel-body" > 
                    <div class="col-lg-6" >
                        <form role="form" method="post" action="<?php echo site_url()?>caraka/simpan_pengajuan" enctype="multipart/form-data" >
                            <h3 style="margin-left:70px"><label><center>Form Pengajuan Barang</center></label></h3>
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter text" type="number" min="0" id="jumlah" name="jumlah" value="1">
