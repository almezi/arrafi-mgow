		...
		<div class="container">					
			<div class="row" >
                ...
                <div class="panel-body" >
					<div class="col-lg-6" >
						<form role="form" method="post" action="<?php echo site_url()?>satpam/simpan_dan_video" enctype="multipart/form-data" >
							...
							<div class="form-group">
						                ...
						                <td>Select Video :</td>
						                <td><input type="file" class="form-control" id="video" name="video" >
						                </td>
