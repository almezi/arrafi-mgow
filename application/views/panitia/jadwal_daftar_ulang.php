                                                            ...
                                                            if ($privilege=='Panitia') {
                                                             ...
                                                             <span></span></a>
                                                                ...
                                                                <?php
                                                                    ...
                                                                    echo anchor('Daftar_Ulang_C/hapus_jadwal_daftar_ulang/'.$value->id_jadwal,' <i style="color:#f05050" class="fa fa-trash-o fa-2x fa-fw"></i> <span></span> ', $attributes);
                                                                ?>
                                                                <?php
                                                            }
                                                        ?>
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <?php
                                ...
                                echo form_open('Daftar_Ulang_C/buat_jadwal_daftar_ulang',$attributes);
                            ?>
                    ...
                    <div class="modal-dialog"> 
                        <div class="modal-content">
                            <?php
                                ...
                                echo form_open('Daftar_Ulang_C/ubah_jadwal_daftar_ulang',$attributes);
                            ?>
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
