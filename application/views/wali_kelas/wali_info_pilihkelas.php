                ...
                <div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Pilih Kelas, Pelajaran <?php echo $_GET['namamapel']; ?> <a style="float:right;" href="<?php echo base_url()?>guru/guru_pilih_nilaisiswa"> <button type="button" class="btn btn-success">Menu</button></a>
                        </div>
                        <!-- /.panel-heading -->
