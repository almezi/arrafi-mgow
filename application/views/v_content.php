...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Aplikasi Manajemen Bagian Keamanan (CARAKA) & Bagian Kebersihan (SATPAM)</h2>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="col-lg-12 panel-body" style="border: solid 0px;">
    HALOOOO.....
    <br>
    ...
    <?php
    /* foreach ($jumNotif->result_array() as $row) {
      echo $row['pemberitahuan'];
      } */
    ?>
