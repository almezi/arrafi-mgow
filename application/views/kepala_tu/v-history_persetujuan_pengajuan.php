            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <tbody>                               
                     ...
                     <tr>
                          <?php  if($row->progres!=null && $row->barang_tersedia!=null  && $row->barang_diambil==null){ ?>
                        <td><?php echo $no?></td>
                 ...
                 <div class="panel panel-default">
                    ...
                    <tbody>                               
                        <?php
                           $no=1;
                            foreach($list_selesai->result()as $row) { 
                        ?> 
...
function upd_pengambilan(id){
    $.ajax({
        url:"http://localhost/iqbal/index.php/kepala_tu/upd_pengambilan/"+id,
