...
<script>
    function search(){
        ...
        // var c  = $('#thn').val();
        $.ajax({
            url:"<?php echo base_url()?>index.php/kepala_tu/filterPeriodeAbsen/"+a,
            success:function(data){
                // alert(data);
                $('#dataKunjungan').html(data);
                //$('#cetak').attr("onClick","window.location = 'http://localhost/ArRafiBR/index.php/Ka_tu/pdf?<?php echo "nip=".$peg['id_pegawai']."&nama=".$peg['nama']."&" ?>bln="+a+"'")
            }
        });
    }
</script>
...
<script>
    ...
    function searchnama(){
        ...
        $.ajax({
            url:"<?php echo base_url()?>index.php/kepala_tu/filterNamaAbsen/"+a,
            method: 'GET',
            data: { nama: a }, 
            success:function(data){
                // alert(data);
...
<div class="col-lg-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                <?php echo anchor('kepala_tu/form_ketidakhadiran','<button class="btn btn-primary"><i class="fa fa-plus">&nbsp;<label>Tambah Ketidakhadiran</label></i></button>')?>
                 
                <?php echo anchor('kepala_tu/form_pergantian','<button class="btn btn-primary"><i class="fa fa-plus">&nbsp;<label>Tambah Pergantian</label></i></button>')?>
                <br><br>
                <div class="panel panel-default">
                    <!-- /.panel-heading -->
                    <div class="panel-body">
