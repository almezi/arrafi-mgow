		...
		<div class="container">
			<div class="row" >
                ...
                <div class="panel-body" >
					<div class="col-lg-6" >
						<form role="form" method="post" action="<?php echo site_url()?>kepala_tu/simpan_edit_jadwal" enctype="multipart/form-data" >
							...
							<div class="form-group">
			                    ...
			                    <input type="date" class="form-control" name="tgl_mulai" id="tgl_mulai" onchange="" value="<?php echo $list_jadwal->tgl_mulai;?>" placeholder="" required>
							</div>
							<div class="form-group">
