		...
		<div class="container">
			<div class="row" >
                ...
                <div class="panel-body" >
					<div class="col-lg-6" >
						<form role="form" method="post" action="<?php echo site_url()?>kepala_tu/simpan_pembg_tugas" enctype="multipart/form-data" >
							...
							<div class="form-group">
			                    ...
			                    <input type="hidden" name="id_jadwal" id="id_jadwal">
			                    <input type="date" data-date-format='yyyy-mm-dd' class="form-control" name="tgl_selesai" id="tgl_selesai" placeholder="" required>
							</div>
