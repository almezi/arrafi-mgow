                ...
                <div >
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Pilih Kelas, Pelajaran <?php echo $_GET['namamapel']; ?> <a style="float:right;" href="<?php echo base_url()?>index.php/guru/nilai_evaluasi_pmp"> <button type="button" class="btn btn-success">Menu Pelajaran</button></a>
                          iufyjdfyjfydyuj
                        </div>
                        <!-- /.panel-heading -->
